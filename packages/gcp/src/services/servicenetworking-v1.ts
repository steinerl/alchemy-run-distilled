...
export const DisableVpcServiceControlsRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    consumerNetwork: Schema.optional(Schema.String),
...
export const EnableVpcServiceControlsRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    consumerNetwork: Schema.optional(Schema.String),
...
export const SecondaryIpRangeSpec = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).annotate({ identifier: "SecondaryIpRangeSpec" });
...
export interface AddSubnetworkRequest {
  ...
  secondaryIpRangeSpecs?: ReadonlyArray<SecondaryIpRangeSpec>;
  ...
  requestedRanges?: ReadonlyArray<string>;
...
export const ConsumerProject = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export interface RangeReservation {
  ...
  secondaryRangeIpPrefixLengths?: ReadonlyArray<number>;
  ...
  subnetworkCandidates?: ReadonlyArray<Subnetwork>;
}

export const RangeReservation = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ipPrefixLength: Schema.optional(Schema.Number),
...
}).annotate({ identifier: "RangeReservation" });
...
export const ValidateConsumerConfigRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    consumerNetwork: Schema.optional(Schema.String),
    ...
    checkServiceNetworkingUsePermission: Schema.optional(Schema.Boolean),
  }).annotate({ identifier: "ValidateConsumerConfigRequest" });
...
export interface ValidateConsumerConfigResponse {
  ...
  existingSubnetworkCandidates?: ReadonlyArray<Subnetwork>;
}

export const ValidateConsumerConfigResponse =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  }).annotate({ identifier: "ValidateConsumerConfigResponse" });
...
export const UpdateConsumerConfigRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const AddRolesRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  consumerNetwork: Schema.optional(Schema.String),
...
export const AddDnsZoneRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  consumerNetwork: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  dnsSuffix: Schema.optional(Schema.String),
}).annotate({ identifier: "AddDnsZoneRequest" });
...
export const RemoveDnsZoneRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  consumerNetwork: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
...
export const DnsZonePair = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export interface ListDnsZonesResponse {
  ...
  dnsZonePairs?: ReadonlyArray<DnsZonePair>;
}

export const ListDnsZonesResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const GetDnsZoneResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  producerPrivateZone: Schema.optional(DnsZone),
  consumerPeeringZone: Schema.optional(DnsZone),
...
export const AddDnsRecordSetRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    consumerNetwork: Schema.optional(Schema.String),
    zone: Schema.optional(Schema.String),
    dnsRecordSet: Schema.optional(DnsRecordSet),
  },
).annotate({ identifier: "AddDnsRecordSetRequest" });
...
export const RemoveDnsRecordSetRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    consumerNetwork: Schema.optional(Schema.String),
    zone: Schema.optional(Schema.String),
    dnsRecordSet: Schema.optional(DnsRecordSet),
  }).annotate({ identifier: "RemoveDnsRecordSetRequest" });
...
export const UpdateDnsRecordSetRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    consumerNetwork: Schema.optional(Schema.String),
    zone: Schema.optional(Schema.String),
    existingDnsRecordSet: Schema.optional(DnsRecordSet),
    newDnsRecordSet: Schema.optional(DnsRecordSet),
  }).annotate({ identifier: "UpdateDnsRecordSetRequest" });

export interface ListDnsRecordSetsResponse {
  /** DNS record Set Resource */
  dnsRecordSets?: ReadonlyArray<DnsRecordSet>;
}

export const ListDnsRecordSetsResponse =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export interface ListPeeredDnsDomainsResponse {
  ...
  peeredDnsDomains?: ReadonlyArray<PeeredDnsDomain>;
}

export const ListPeeredDnsDomainsResponse =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
